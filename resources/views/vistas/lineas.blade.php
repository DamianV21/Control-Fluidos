                    ...
                    <div class="collapse my-1 fixed-start ms-4 show" id="collapseExample">
                        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item" style="<?php echo $ocultar1[auth()->user()->role_id]; ?>">
                                    <a class="nav-link active" href="lineas">
                                        <div
                                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <svg width="15px" height="15px" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 640 512">
...
@section('templatePaginacion')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Líneas</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Información de Líneas</h6>
    </nav>
@endsection

@section('templateBase')
    <title>Información de Líneas | CFDA</title>
